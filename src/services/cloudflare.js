...
class Cloudflare extends Client {
    ...
    async uploadImage(filePath) {
        ...
        const resultado = await this.client.post('/accounts/6abea4e7ae6631c1f0e3ada29a2d7eaa/images/v1', formData);
        return resultado.data; // Retorna los datos de la respuesta
    }

    // Método para eliminar una imagen en Cloudflare mediante su ID
    deleteImage(imageId) {
        return this.client.delete('/accounts/6abea4e7ae6631c1f0e3ada29a2d7eaa/images/v1/' + imageId);
    }
    ...
    async listImages() {
        ...
        const resultado = await this.client.get('/accounts/6abea4e7ae6631c1f0e3ada29a2d7eaa/images/v1');
